export const Stars = function(args) {
    ...
    var Star = function() {
        ...
        this.init = function() {
            ...
            this.lineWidth = 0;
            this.vel = {
                x: _scope.initVel.current * (Math.random() * 10 - 5),
                y: _scope.initVel.current * (Math.random() * 10 - 5)
            }
        }
        this.update = function() {
            this.vel.x *= _scope.transitVel.current;
            this.vel.y *= _scope.transitVel.current;
            this.lineWidth += 0.035 * _scope.initVel.current;
            this.x0 = this.x;
            this.y0 = this.y;
            this.x += this.vel.x;
            this.y += this.vel.y;
